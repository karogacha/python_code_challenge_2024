...
def main():
    ...
    my_list=retrieve_list_numbers(3)
    num_max = largest_number(my_list)
    print(f"Given the following list {my_list}, the largest number is: {num_max}")
